...
```{r, echo=FALSE, eval=mfdb::mfdb(check_db_available = TRUE)}
ok(all.equal(dat, read.table(blank.lines.skip = TRUE, header = TRUE, stringsAsFactors = FALSE, text = '
year step area     mean
2018    1   a1 5.131353
2018    1   a2 5.286022
2018    2   a1 5.772876
...
2018    4   a1 6.144197
2018    4   a2 6.020029
', colClasses = c(NA, 'character', NA, NA)), tolerance = 1e-7), "extract mean bottom temperature by quarter and area")
```
