...
```
```{r, message=FALSE, echo=FALSE}
# NB: DuckDB 0.2.9 -> 0.3.0 switches ORDER BY default to NULLS LAST, hide difference
ok(ut_cmp_equal(unattr(agg_data[[1]][order(agg_data[[1]]$tow_bait_type),]), table_string('
...
```{r, message=FALSE, echo=FALSE}
# NB: DuckDB 0.2.9 -> 0.3.0 switches ORDER BY default to NULLS LAST, hide difference
ok(ut_cmp_equal(unattr(agg_data[[1]][order(agg_data[[1]]$tow_net_type),]), table_string('
