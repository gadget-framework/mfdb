...
section("Can generate gadgetfile objects", function() {
    expect_error(
        gadget_file(),
        "file_name")
...
section("Can get a string representation", function() {
    expect_string(
...
section("Can add components and preambles", function() {
    expect_string(
        gadget_file("wobble",
            components = list(
...
section("Can include tabular data", function() {
    expect_string(
        gadget_file("wobble",
...
section("Can read gadget files", function() {
