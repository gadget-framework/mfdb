...
section("Can generate gadgetfile objects", {
    expect_error(
        gadget_file(),
        "file_name")
...
section("Can get a string representation", {
    expect_string(
...
section("Can add components and preambles", {
    expect_string(
        gadget_file("wobble",
            components = list(
...
section("Can include tabular data", {
    expect_string(
        gadget_file("wobble",
